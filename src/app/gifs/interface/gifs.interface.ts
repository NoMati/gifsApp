...
export enum Title {
    Area51RunningGIFByMOODMAN = "Area 51 Running GIF by MOODMAN",
    NarutoShippudenGIF = "Naruto Shippuden GIF",
    TitleNarutoShippudenGIF = "naruto shippuden GIF",
}
...
export class Convert {
    public static toGifsApp(json: string): SearchGifResponse {
        return cast(JSON.parse(json), r("GifsApp"));
    }

    public static gifsAppToJson(value: SearchGifResponse): string {
